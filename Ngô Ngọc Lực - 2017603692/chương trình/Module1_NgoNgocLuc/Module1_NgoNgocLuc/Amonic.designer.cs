...
namespace Module1_NgoNgocLuc
{
    ...
    partial void DeleteUser(User instance);
		...
		public AmonicDataContext() : 
				base(global::Module1_NgoNgocLuc.Properties.Settings.Default.session1ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Crash")]
    ...
    partial void OnCrasherChanging(bool value);
    partial void OnCrasherChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Crasher", DbType="Bit NOT NULL")]
		public bool Crasher
		{
			get
			{
				return this._Crasher;
			}
			set
			{
				if ((this._Crasher != value))
				{
					this.OnCrasherChanging(value);
					this.SendPropertyChanging();
					this._Crasher = value;
					this.SendPropertyChanged("Crasher");
					this.OnCrasherChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Crash", Storage="_User", ThisKey="UserID", OtherKey="ID", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnActiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Crash", Storage="_Crashes", ThisKey="ID", OtherKey="UserID")]
